...
<head>
    ...
    <!-- font icons -->
<link href="public_html/assets/vendors/themify-icons/css/themify-icons.css" rel="stylesheet" />
    <!-- Bootstrap + LeadMark main styles -->
<link href="public_html/assets/css/leadmark.css" rel="stylesheet" />
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="navbar custom-navbar navbar-expand-md navbar-light fixed-top" data-spy="affix" data-offset-top="10">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="public_html/assets/imgs/logo.svg" alt="">
            </a>
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="subtitle">Your Save Password</h1>
            <h1 class="title">Smart Khan WebSite</h1>  
        </div>  
        <div class="shape">
        ...
        <div class="container">
            ...
            <div class="portfolio-container"> 
                ...
                <div class="col-md-6 col-lg-4 advertising new">
                    <div class="portfolio-item">
                  <%--<img src="public_html/assets/imgs/advertising-2.jpg" />--%>
    ...
    <section id="contact" class="section has-img-bg pb-0">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-7">
                    <form>
                        <h4 class="mb-4">Login ID Password</h4>
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-4">
                                <input type="text" class="form-control text-white rounded-0 bg-transparent" name="Password" placeholder="Password">
                            </div>
